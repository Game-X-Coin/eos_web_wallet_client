...
class Welcome extends React.Component {
  ...
  render() {
    ...
    const keys = authStore.values.keys;
    console.log(keys);
    ...
    return <Layout className="default-top-layout" id="welcome">
      ...
      <Content className="links">
        <h2>Welcome! <Link
          to={'/@currentUser.account'}>{currentUser.account}</Link></h2>
        <h2>Keys</h2>
        <ul className={"keys"}>
        ...
        <h2>Your account has been generated! Your private keys are not saved in server and show just once.<br/>
        Write down private keys in secure place for future use.</h2>
